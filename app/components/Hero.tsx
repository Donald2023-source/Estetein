  ...
  return (
    <div>
        <div className='flex lg:flex-row md:flex-row flex-col-reverse lg:items-start items-center'>
            ...
            <div>
                <Image className='lg:rounded-none md:rounde-none rounded-lg' src={heroImage} alt=''/>
            </div>
        </div>
        ...
        <div className='grid lg:grid-cols-4 grid-cols-2  gap-2 justify-between py-3'>
            {
                cardData.map((data, id) => (
                    <div className='flex flex-col items-center lg:px-12 px-4 shadow-lg rounded-lg bg-black/70 hover:bg-black text-white py-3 justify-center gap-3' key={id}>
